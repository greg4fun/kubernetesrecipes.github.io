...
flowchart TB
    subgraph PLATFORM["👥 Platform Team"]
        XRD["📋 Define Composite Resources - XRDs<br/>• DatabaseClaim<br/>• NetworkClaim<br/>• StorageBucketClaim"]
    end
    ...
    subgraph K8S["☸️ Kubernetes Cluster"]
        subgraph CP["🔧 Crossplane"]
            AWS_PROV["🟠 AWS<br/>Provider"]
            GCP_PROV["🔵 GCP<br/>Provider"]
            AZURE_PROV["🟣 Azure<br/>Provider"]
        end
    end
