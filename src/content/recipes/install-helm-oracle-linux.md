...
tags: ["helm", "installation", "oracle-linux", "package-manager", "charts"]
author: "Luca Berton"
relatedRecipes:
...
> 💡 **Quick Answer:** Install Helm 3 on Oracle Linux and configure chart repositories. Covers package manager install, script install, and shell completion for Oracle Linux 8/9.

## The Problem

You need Helm installed on Oracle Linux (Oracle Linux 8/9) to manage Kubernetes application deployments with charts.
