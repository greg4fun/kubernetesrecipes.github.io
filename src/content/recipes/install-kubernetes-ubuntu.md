...
tags: ["kubernetes", "installation", "ubuntu", "kubeadm", "containerd"]
author: "Luca Berton"
relatedRecipes:
  - "install-helm-ubuntu"
...
> 💡 **Quick Answer:** Step-by-step guide to install Kubernetes on Ubuntu with kubeadm. Covers containerd, kubeadm init, CNI setup, and worker node joining for Ubuntu 22.04/24.04.

## The Problem

You need to install a production-ready Kubernetes cluster on Ubuntu (Ubuntu 22.04/24.04). This guide covers the complete process from prerequisites to a running cluster.
