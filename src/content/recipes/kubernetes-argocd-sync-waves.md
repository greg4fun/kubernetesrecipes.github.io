---
title: "ArgoCD Sync Waves and Hooks Guide"
...
argocd sync waves and hooks is a common operational challenge in production Kubernetes clusters. This recipe provides systematic debugging steps and production-proven solutions.
...
```yaml
# ArgoCD Sync Waves and Hooks configuration
apiVersion: v1
kind: ConfigMap
metadata:
  name: kubernetes-argocd-sync-waves-config
data:
  config.yaml: |
    enabled: true
```
