...
> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on RHEL. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.

## The Problem

You have a Kubernetes cluster on RHEL and need GitOps-based continuous delivery. ArgoCD watches your Git repository and automatically syncs changes to your cluster.

## The Solution

### Prerequisites

- Running Kubernetes cluster (see [Install Kubernetes on RHEL](/recipes/deployments/install-kubernetes-rhel/))
- kubectl configured and working
- Helm installed (see [Install Helm on RHEL](/recipes/helm/install-helm-rhel/))
