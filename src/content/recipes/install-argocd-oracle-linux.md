---
title: "Install ArgoCD on Oracle Linux"
description: "Deploy ArgoCD on Kubernetes running on Oracle Linux. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support."
category: "deployments"
difficulty: "beginner"
publishDate: "2026-04-02"
tags: ["argocd", "gitops", "installation", "oracle-linux", "continuous-delivery"]
author: "Luca Berton"
relatedRecipes:
  - "install-kubernetes-oracle-linux"
  - "install-helm-oracle-linux"
  - "argocd-sync-waves-ordering"
---

> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on Oracle Linux. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.

## The Problem

You have a Kubernetes cluster on Oracle Linux and need GitOps-based continuous delivery. ArgoCD watches your Git repository and automatically syncs changes to your cluster.

## The Solution

### Prerequisites

- Running Kubernetes cluster (see [Install Kubernetes on Oracle Linux](/recipes/deployments/install-kubernetes-oracle-linux/))
- kubectl configured and working
- Helm installed (see [Install Helm on Oracle Linux](/recipes/helm/install-helm-oracle-linux/))
