...
> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on Arch Linux. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.

## The Problem

You have a Kubernetes cluster on Arch Linux and need GitOps-based continuous delivery. ArgoCD watches your Git repository and automatically syncs changes to your cluster.

## The Solution

### Prerequisites

- Running Kubernetes cluster (see [Install Kubernetes on Arch Linux](/recipes/deployments/install-kubernetes-arch-linux/))
- kubectl configured and working
- Helm installed (see [Install Helm on Arch Linux](/recipes/helm/install-helm-arch-linux/))
