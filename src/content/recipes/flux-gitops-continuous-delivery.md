...
flowchart TB
    ...
    GIT -->|"🔄 Git Pull (every 1m)"| FLUX

    subgraph FLUX["🔷 Flux CD Controllers"]
        SOURCE["📡 Source<br/>Controller"]
        KUST_CTRL["🔧 Kustomize<br/>Controller"]
        HELM_CTRL["⎈ Helm<br/>Controller"]
    end

    FLUX -->|"⚡ Apply/Reconcile"| K8S
    ...
    K8S -->|"📊 Status Updates"| NOTIFY

    subgraph NOTIFY["📢 Notifications"]
        SLACK["💬 Slack, Teams, etc."]
    end
```
