...
description: "Use ArgoCD sync waves and PreSync hooks to safely run database migrations before deploying application code, with rollback strategies and zero-downtime patterns."
