...
tags: ["argocd", "gitops", "installation", "rocky-linux", "continuous-delivery"]
author: "Luca Berton"
relatedRecipes:
...
> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on Rocky Linux. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.

## The Problem

You have a Kubernetes cluster on Rocky Linux and need GitOps-based continuous delivery. ArgoCD watches your Git repository and automatically syncs changes to your cluster.

## The Solution

### Prerequisites

- Running Kubernetes cluster (see [Install Kubernetes on Rocky Linux](/recipes/deployments/install-kubernetes-rocky-linux/))
- kubectl configured and working
- Helm installed (see [Install Helm on Rocky Linux](/recipes/helm/install-helm-rocky-linux/))
