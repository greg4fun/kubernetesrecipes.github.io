---
title: "Install Kubernetes on Oracle Linux"
description: "Step-by-step guide to install Kubernetes on Oracle Linux with kubeadm. Covers containerd, kubeadm init, CNI setup, and worker node joining for Oracle Linux 8/9."
category: "deployments"
difficulty: "beginner"
publishDate: "2026-04-02"
tags: ["kubernetes", "installation", "oracle-linux", "kubeadm", "containerd"]
author: "Luca Berton"
relatedRecipes:
  - "install-helm-oracle-linux"
  - "install-argocd-oracle-linux"
  - "kubernetes-debugging-toolkit"
---

> 💡 **Quick Answer:** Step-by-step guide to install Kubernetes on Oracle Linux with kubeadm. Covers containerd, kubeadm init, CNI setup, and worker node joining for Oracle Linux 8/9.

## The Problem

You need to install a production-ready Kubernetes cluster on Oracle Linux (Oracle Linux 8/9). This guide covers the complete process from prerequisites to a running cluster.
