---
title: "Install ArgoCD on Amazon Linux"
description: "Deploy ArgoCD on Kubernetes running on Amazon Linux. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support."
category: "deployments"
difficulty: "beginner"
publishDate: "2026-04-02"
tags: ["argocd", "gitops", "installation", "amazon-linux", "continuous-delivery"]
author: "Luca Berton"
relatedRecipes:
...
> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on Amazon Linux. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.

## The Problem

You have a Kubernetes cluster on Amazon Linux and need GitOps-based continuous delivery. ArgoCD watches your Git repository and automatically syncs changes to your cluster.

## The Solution

### Prerequisites

- Running Kubernetes cluster (see [Install Kubernetes on Amazon Linux](/recipes/deployments/install-kubernetes-amazon-linux/))
- kubectl configured and working
- Helm installed (see [Install Helm on Amazon Linux](/recipes/helm/install-helm-amazon-linux/))
