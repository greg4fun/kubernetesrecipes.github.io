---
title: "nvidia-smi Monitoring in K8s Pods"
description: "Run nvidia-smi inside Kubernetes pods for GPU monitoring. Memory usage, temperature, utilization, and automated health checks with liveness probes."
...
```yaml
# nvidia-smi Monitoring in K8s Pods — production configuration
apiVersion: v1
kind: Pod
metadata:
  name: gpu-workload
