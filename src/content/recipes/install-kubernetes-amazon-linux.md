---
title: "Install Kubernetes on Amazon Linux"
description: "Install Kubernetes on Amazon Linux with kubeadm. Covers containerd setup, kubeadm init, Calico CNI, and worker node joining for Amazon Linux 2023."
category: "deployments"
difficulty: "beginner"
publishDate: "2026-04-02"
tags: ["kubernetes", "installation", "amazon-linux", "kubeadm", "containerd"]
author: "Luca Berton"
relatedRecipes:
...
> 💡 **Quick Answer:** Install Kubernetes on Amazon Linux with kubeadm. Covers containerd setup, kubeadm init, Calico CNI, and worker node joining for Amazon Linux 2023.

## The Problem

You need to install a production-ready Kubernetes cluster on Amazon Linux (Amazon Linux 2023). This guide covers the complete process from prerequisites to a running cluster.
