---
title: "GPU Time-Slicing vs MIG Comparison"
description: "Compare NVIDIA GPU time-slicing and MIG for K8s workloads. When to use each, performance trade-offs, and configuration examples."
...
```yaml
# GPU Time-Slicing vs MIG Comparison — production example
apiVersion: v1
kind: ConfigMap
metadata:
