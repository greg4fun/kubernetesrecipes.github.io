---
title: "Install ArgoCD on Debian: Step-by-Step Guide"
description: "Deploy ArgoCD on Kubernetes running on Debian. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support."
category: "deployments"
difficulty: "beginner"
publishDate: "2026-04-02"
tags: ["argocd", "gitops", "installation", "debian", "continuous-delivery"]
author: "Luca Berton"
relatedRecipes:
  - "install-kubernetes-debian"
  - "install-helm-debian"
  - "argocd-sync-waves-ordering"
---

> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on Debian. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.

## The Problem

You have a Kubernetes cluster on Debian and need GitOps-based continuous delivery. ArgoCD watches your Git repository and automatically syncs changes to your cluster.

## The Solution

### Prerequisites

- Running Kubernetes cluster (see [Install Kubernetes on Debian](/recipes/deployments/install-kubernetes-debian/))
- kubectl configured and working
- Helm installed (see [Install Helm on Debian](/recipes/helm/install-helm-debian/))
