---
title: "Install Kubernetes on SUSE SLES"
description: "Step-by-step guide to install Kubernetes on SUSE SLES with kubeadm. Covers containerd, kubeadm init, CNI setup, and worker node joining for SLES 15."
category: "deployments"
difficulty: "beginner"
publishDate: "2026-04-02"
tags: ["kubernetes", "installation", "suse-sles", "kubeadm", "containerd"]
author: "Luca Berton"
relatedRecipes:
  - "install-helm-suse-sles"
  - "install-argocd-suse-sles"
  - "kubernetes-debugging-toolkit"
---

> 💡 **Quick Answer:** Step-by-step guide to install Kubernetes on SUSE SLES with kubeadm. Covers containerd, kubeadm init, CNI setup, and worker node joining for SLES 15.

## The Problem

You need to install a production-ready Kubernetes cluster on SUSE SLES (SLES 15). This guide covers the complete process from prerequisites to a running cluster.
