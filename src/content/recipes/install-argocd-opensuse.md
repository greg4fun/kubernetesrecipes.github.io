...
tags: ["argocd", "gitops", "installation", "opensuse", "continuous-delivery"]
author: "Luca Berton"
relatedRecipes:
...
> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on openSUSE. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.
...
- Running Kubernetes cluster (see [Install Kubernetes on openSUSE](/recipes/deployments/install-kubernetes-opensuse/))
- kubectl configured and working
- Helm installed (see [Install Helm on openSUSE](/recipes/helm/install-helm-opensuse/))
