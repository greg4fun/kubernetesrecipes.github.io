---
title: "400 Recipes Milestone: What We Built and What's Next"
description: "Kubernetes Recipes reaches 400 production-ready articles. Explore new AI/GPU infrastructure, NVIDIA networking, ArgoCD GitOps, OpenShift, and RHACS security recipes."
...
- **Training** — [NeMo training](/recipes/ai/nvidia-nemo-training-kubernetes/), [distributed training with Kubeflow](/recipes/ai/distributed-training-kubeflow-operator/), [MPI Operator](/recipes/ai/mpi-operator-kubernetes/)
- **Multi-Tenant GPU** — [namespace isolation](/recipes/ai/multi-tenant-gpu-namespace-isolation/), [ResourceQuotas](/recipes/ai/resourcequota-limitrange-gpu/), [time-slicing vs MIG](/recipes/ai/timeslicing-mig-full-gpu/), [chargeback monitoring](/recipes/ai/gpu-tenant-monitoring-chargeback/)
...
- **SR-IOV** — [VF configuration](/recipes/networking/sriov-nicclusterpolicy-vfs/), [AI workload binding](/recipes/networking/sriov-vf-ai-workloads/), [mixed NIC generations](/recipes/networking/sriov-mixed-nic-gpu-nodes/), [troubleshooting](/recipes/networking/sriov-vf-troubleshooting/)
- **NFSoRDMA** — [dedicated NIC setup](/recipes/networking/nfsordma-dedicated-nic/), [bonding](/recipes/networking/nfsordma-bond-access-mode/), [PV integration](/recipes/networking/nfsordma-persistent-volume/), [performance tuning](/recipes/networking/nfsordma-troubleshooting-performance/)
- **DOCA/MOFED** — [driver containers on OpenShift](/recipes/networking/doca-driver-openshift-dtk/), [NIC driver entrypoint deep-dive](/recipes/networking/nvidia-nic-driver-container-entrypoint/)
...
- **Image Mirroring** — [IDMS](/recipes/configuration/openshift-idms-install-config/), [ITMS](/recipes/configuration/openshift-itms-image-tag-mirror/), [MCP rollout management](/recipes/configuration/openshift-mcp-itms-rollout/)
...
- **Registry** — [Quay robot accounts](/recipes/security/quay-robot-account-kubernetes/), [default permissions](/recipes/security/quay-default-permissions-robot/), [token rotation](/recipes/security/rotate-quay-robot-tokens/)
...
- **Deployments** — [rolling updates](/recipes/deployments/rolling-update-strategies/), [canary](/recipes/deployments/canary-deployments/), [blue-green](/recipes/deployments/blue-green-deployments/), [probes](/recipes/deployments/liveness-readiness-probes/)
- **Security** — [NetworkPolicies](/recipes/security/network-policies/), [Pod Security](/recipes/security/pod-security-standards/), [RBAC](/recipes/security/rbac-configuration/), [secrets management](/recipes/security/configmap-secrets-management/)
