---
title: "Backstage Developer Portal Kubernetes"
description: "Deploy Backstage as an internal developer portal on Kubernetes. Kubernetes plugin, catalog integration, and developer self-service for platform engineering."
...
> 💡 **Quick Answer:** Deploy Backstage as an internal developer portal on Kubernetes. Kubernetes plugin, catalog integration, and developer self-service for platform engineering.

## The Problem

backstage developer portal kubernetes is a common operational challenge in production Kubernetes clusters. This recipe provides systematic debugging steps and production-proven solutions.
...
```yaml
# Backstage Developer Portal Kubernetes configuration
apiVersion: v1
kind: ConfigMap
metadata:
  name: kubernetes-backstage-developer-portal-config
data:
  config.yaml: |
    enabled: true
```
