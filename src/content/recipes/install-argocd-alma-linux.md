...
tags: ["argocd", "gitops", "installation", "alma-linux", "continuous-delivery"]
author: "Luca Berton"
relatedRecipes:
  - "install-kubernetes-alma-linux"
  - "install-helm-alma-linux"
  - "argocd-sync-waves-ordering"
---

> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on AlmaLinux. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.

## The Problem

You have a Kubernetes cluster on AlmaLinux and need GitOps-based continuous delivery. ArgoCD watches your Git repository and automatically syncs changes to your cluster.

## The Solution

### Prerequisites

- Running Kubernetes cluster (see [Install Kubernetes on AlmaLinux](/recipes/deployments/install-kubernetes-alma-linux/))
- kubectl configured and working
- Helm installed (see [Install Helm on AlmaLinux](/recipes/helm/install-helm-alma-linux/))
