---
title: "CUDA Version Compatibility K8s Guide"
description: "Match CUDA versions with GPU drivers and container images on Kubernetes. Forward compatibility, driver requirements, and container toolkit matrix."
...
> 💡 **Quick Answer:** Match CUDA versions with GPU drivers and container images on Kubernetes. Forward compatibility, driver requirements, and container toolkit matrix.
...
```yaml
# CUDA Version Compatibility K8s Guide — production configuration
apiVersion: v1
kind: Pod
metadata:
  name: gpu-workload
