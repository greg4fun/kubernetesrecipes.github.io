---
title: "Install ArgoCD on SUSE SLES: Step-by-Step"
description: "Deploy ArgoCD on Kubernetes running on SUSE SLES. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support."
category: "deployments"
difficulty: "beginner"
publishDate: "2026-04-02"
tags: ["argocd", "gitops", "installation", "suse-sles", "continuous-delivery"]
author: "Luca Berton"
relatedRecipes:
  - "install-kubernetes-suse-sles"
  - "install-helm-suse-sles"
  - "argocd-sync-waves-ordering"
---

> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on SUSE SLES. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.

## The Problem

You have a Kubernetes cluster on SUSE SLES and need GitOps-based continuous delivery. ArgoCD watches your Git repository and automatically syncs changes to your cluster.

## The Solution

### Prerequisites

- Running Kubernetes cluster (see [Install Kubernetes on SUSE SLES](/recipes/deployments/install-kubernetes-suse-sles/))
- kubectl configured and working
- Helm installed (see [Install Helm on SUSE SLES](/recipes/helm/install-helm-suse-sles/))
