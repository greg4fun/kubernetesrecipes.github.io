...
> 💡 **Quick Answer:** Deploy ArgoCD on Kubernetes running on Ubuntu. GitOps continuous delivery with automated sync, self-healing, and multi-cluster support.

## The Problem

You have a Kubernetes cluster on Ubuntu and need GitOps-based continuous delivery. ArgoCD watches your Git repository and automatically syncs changes to your cluster.

## The Solution

### Prerequisites

- Running Kubernetes cluster (see [Install Kubernetes on Ubuntu](/recipes/deployments/install-kubernetes-ubuntu/))
- kubectl configured and working
- Helm installed (see [Install Helm on Ubuntu](/recipes/helm/install-helm-ubuntu/))
