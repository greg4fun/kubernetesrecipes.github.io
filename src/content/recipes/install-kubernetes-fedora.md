...
tags: ["kubernetes", "installation", "fedora", "kubeadm", "containerd"]
author: "Luca Berton"
relatedRecipes:
  - "install-helm-fedora"
  - "install-argocd-fedora"
  - "kubernetes-debugging-toolkit"
---

> 💡 **Quick Answer:** Step-by-step guide to install Kubernetes on Fedora with kubeadm. Covers containerd, kubeadm init, CNI setup, and worker node joining for Fedora 39/40.

## The Problem

You need to install a production-ready Kubernetes cluster on Fedora (Fedora 39/40). This guide covers the complete process from prerequisites to a running cluster.
