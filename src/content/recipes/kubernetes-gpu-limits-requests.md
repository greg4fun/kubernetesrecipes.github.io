---
title: "K8s GPU Limits Requests Configuration"
description: "Configure GPU resource limits and requests in Kubernetes pod specs. nvidia.com/gpu resource, fractional GPUs, MIG slices, and multi-GPU allocation."
...
Configure GPU resource limits and requests in Kubernetes pod specs. Without proper setup, GPU workloads on Kubernetes suffer from wasted resources, failed scheduling, or degraded inference performance.
...
```yaml
# K8s GPU Limits Requests Configuration — production configuration
apiVersion: v1
kind: Pod
metadata:
  name: gpu-workload
...
- K8s GPU Limits Requests Configuration is critical for production GPU workloads on Kubernetes
