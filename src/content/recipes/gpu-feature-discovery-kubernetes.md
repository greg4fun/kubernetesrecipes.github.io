---
title: "GPU Feature Discovery Node Labels"
description: "Configure NVIDIA GPU Feature Discovery for automatic node labeling on Kubernetes. GPU model, driver version, CUDA, and MIG labels for scheduling."
...
```yaml
# GPU Feature Discovery Node Labels — production configuration
apiVersion: v1
kind: Pod
metadata:
  name: gpu-workload
