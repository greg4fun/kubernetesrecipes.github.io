---
title: "Install Kubernetes on CentOS Stream"
description: "Step-by-step guide to install Kubernetes on CentOS Stream with kubeadm. Covers containerd, kubeadm init, CNI setup, and worker node joining for CentOS Stream 9."
category: "deployments"
difficulty: "beginner"
publishDate: "2026-04-02"
tags: ["kubernetes", "installation", "centos-stream", "kubeadm", "containerd"]
author: "Luca Berton"
relatedRecipes:
  - "install-helm-centos-stream"
  - "install-argocd-centos-stream"
  - "kubernetes-debugging-toolkit"
---

> 💡 **Quick Answer:** Step-by-step guide to install Kubernetes on CentOS Stream with kubeadm. Covers containerd, kubeadm init, CNI setup, and worker node joining for CentOS Stream 9.

## The Problem

You need to install a production-ready Kubernetes cluster on CentOS Stream (CentOS Stream 9). This guide covers the complete process from prerequisites to a running cluster.
